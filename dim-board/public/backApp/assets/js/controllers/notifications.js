            ...
            switch ($scope.notification.type) {
                ...
                case 'circle':
                    ...
                    $('body').pgNotification({
                        ...
                        timeout: 0,
                        type: color,
                        thumbnail: '<img width="40" height="40" style="display: inline-block;" src="../backApp/../backApp/assets/img/profiles/avatar2x.jpg" data-src="../backApp/../backApp/assets/img/profiles/avatar.jpg" ui-jq="unveil" data-src-retina="../backApp/../backApp/assets/img/profiles/avatar2x.jpg" alt="">'
                    }).show();
                    break;
                case 'simple':
